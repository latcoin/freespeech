...
freespeech = AuthServiceProxy(serverUrl)
...
try:
    ...
    db = MyDb()
    db.usernames = {}
    nextHash = freespeech.getblockhash(0)

while True:
    block = freespeech.getblock(nextHash)
